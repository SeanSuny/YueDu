...
for i, account in enumerate(accounts_list, start=1):
    ...
    mobile, token = values[0], values[1]
    print(f"\n{'=' * 8}开始执行账号[{mobile}]{'=' * 8}")
    time.sleep(3)
    ...
    url = f"https://www.57box.cn/app/index.php?i=2&t=0&v=1&from=wxapp&c=entry&a=wxapp&do=getuserinfo&&state={token}"
    data = {
        "m": "greatriver_lottery_operation",
        "title": "",
    }
    ...
    if lottery == 1:  # 开始抽奖
        ...
        for i in range(10):
            ...
            if response['errno'] == 0:
                ...
                break
        print(f"开盒完毕")
        url = f"https://www.57box.cn/app/index.php?i=2&t=0&v=1&from=wxapp&c=entry&a=wxapp&do=uptaskinfo&&state={token}"
        data = {
            "m": "greatriver_lottery_operation",
            "id": "39",
            "answer": ""
